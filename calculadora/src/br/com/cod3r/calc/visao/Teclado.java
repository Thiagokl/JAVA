...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		GridBagLayout layuot = new GridBagLayout();
		...
		adicionarBotao("7", COR_CINZA_CLARO, c, 0, 1); // Linha 2
		adicionarBotao("8", COR_CINZA_CLARO,c, 1, 1);
		adicionarBotao("9", COR_CINZA_CLARO, c, 2, 1);
		adicionarBotao("*", COR_LARANJA, c, 3, 1);
		
		
		adicionarBotao("4", COR_CINZA_CLARO, c, 0, 2);   // Linha 3
		...
		adicionarBotao("1", COR_CINZA_CLARO, c, 0, 3);    // Linha 4
		...
		c.gridwidth = 2;
		adicionarBotao("0", COR_CINZA_CLARO, c, 0, 4);   // Linha 5
		c.gridwidth = 1;
